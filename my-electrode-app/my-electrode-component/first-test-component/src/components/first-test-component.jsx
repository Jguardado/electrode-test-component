...
import styles from "../../src/styles/first-test-component.css";
import RenderFriend from "./render-friend";
import GuestList from "./guest-list";

export default class FirstTestComponent extends Component {
...
FirstTestComponent.displayName = "FirstTestComponent";

FirstTestComponent.propTypes = {
...
FirstTestComponent.defaultProps = {
  ourFriends: [],
  message: () => {
